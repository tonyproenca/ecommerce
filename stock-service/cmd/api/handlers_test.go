...
func TestRetrieveStockProduct(t *testing.T) {
	...
	repositoryMock.On("GetOne", "123").Return(&data.StockProduct{
		ID:          "123",
		ProductCode: "1",
		ProductName: "product",
		Quantity:    0,
...
func TestRetrieveStockProductDatabaseError(t *testing.T) {
	...
	repositoryMock.On("GetOne", mock.Anything).Return((*data.StockProduct)(nil), errors.New("mongo: no documents in result")).Times(1)
